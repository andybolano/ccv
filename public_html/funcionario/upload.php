...
$ruta = '../../../sgc/files/'; //Decalaramos una variable con la ruta en donde almacenaremos los archivos
 ...
 //Movemos el archivo temporal a la ruta especificada	*
   ...
   $hoy = date("Y-m-d");
     ...
     $sql = "INSERT INTO documentos(url,idArchivo,fecha,version,nota,estado,idFuncionario_subio,id_funcionario_actualizo,ubicacion)
         VALUES ('$destino_guardar','$ultimoId','$fechaActualizacion','$version','$cambio','ESPERANDO APROBACION','$id_funcionario','','$ubicacion')";
